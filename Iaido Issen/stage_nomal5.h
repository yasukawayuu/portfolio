...
private:
	...
	D3DXVECTOR2 m_pos[NUM_BLOCKNORMAL5];		    //ポジション
	D3DXVECTOR2 m_wh[NUM_BLOCKNORMAL5];			//大きさ
...
public:
	STAGE_NOMAL5(D3DXVECTOR2* playerpos, D3DXVECTOR2 *base) :m_playerpos(playerpos), m_base(base) {}
	~STAGE_NOMAL5() {}
	void Init(void);
	void Uninit(void);
	void Draw(void);
