...
private:
	...
	D3DXVECTOR2 m_pos[NUM_BLOCKNORMAL3];		    //ポジション
	D3DXVECTOR2 m_wh[NUM_BLOCKNORMAL3];			//大きさ
...
public:
	STAGE_NOMAL3(D3DXVECTOR2* playerpos, D3DXVECTOR2 *base) :m_playerpos(playerpos), m_base(base) {}
	~STAGE_NOMAL3() {}
	void Init(void);
	void Uninit(void);
	void Draw(void);
